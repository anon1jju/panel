...
// --- Konfigurasi ---
$emailValidationServiceKeyFile = 'key3.json'; // File untuk API key layanan validasi email
$output = [];
...
$url = 'https://ws.postcoder.com/pcw/' . urlencode($serviceApiKey) . '/email/' . $encodedEmailToValidate;
