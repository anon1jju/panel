...
// --- Konfigurasi ---
$emailValidationServiceKeyFile = 'key5.json'; // File untuk API key layanan validasi email
$output = [];
...
//$url = 'https://www.tjc.co.uk/on/demandware.store/Sites-TJC-GB-Site/en/AddressCapture-EmailAddressValidation?emailId='.$encodedEmailToValidate.'&pageContext=sweepstakes';
$url = "https://api.ideal-postcodes.co.uk/v1/emails?api_key=".$serviceApiKey."&query=".$emailToValidate;
